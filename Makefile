...
#    Updated: 2023/06/16 08:48:37 by eguelin          ###   ########lyon.fr    #
#                                                                              #
# **************************************************************************** #
...
OTHER_DIR = other/
FILES_OTHER = ft_atoi.c ft_bzero.c ft_calloc.c ft_free_split.c ft_itoa.c ft_split.c ft_tolower.c ft_toupper.c
